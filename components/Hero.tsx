            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                        <button className="brand-gradient brand-gradient-hover text-white font-bold py-4 px-10 rounded-lg text-lg transition-all shadow-lg">
                            Get Started Free
                        </button>
                        <button className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white font-bold py-4 px-10 rounded-lg text-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
                            Learn More
                        </button>
                    </div>
                </div>
                <div className="flex-1 w-full">
                    <div className="relative w-full aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-primary/5 to-brand-pink/5 flex items-center justify-center p-8">
                        ...
                        ></div>
                        <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-xl flex items-center gap-3 border border-gray-100 dark:border-gray-700">
