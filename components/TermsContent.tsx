                ...
                {[
                    {
                        ...
                        content: (
                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                                By accessing or using QR Scanner (“Service”), you agree to be legally bound by these Terms & Conditions. If you disagree with any provision, you must immediately cease use of the Service.
                            </p>
                        )
                    },
                    {
                        ...
                        content: (
                            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                                <li className="flex gap-3">
                                    ...
                                    <span>Refers to the QR Scanner website and applications.</span>
                                </li>
                                <li className="flex gap-3">
                                ...
                                <li className="flex gap-3">
                                    <span className="font-bold text-[#131118] dark:text-white min-w-[100px]">“Scan History”:</span>
                                    <span>Refers to the cloud database records storing codes scanned or generated by the User.</span>
                                </li>
                                <li className="flex gap-3">
                                    <span className="font-bold text-[#131118] dark:text-white min-w-[100px]">“Account Profile”:</span>
                                    <span>Refers to the user identity data, including credentials and uploaded profile pictures.</span>
                                </li>
                            </ul>
                        )
                    },
                        ...
                        content: (
                            <>
                                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                                    QR Scanner provides barcode and QR code utilities, including real-time code scanning, custom code generation, profile photo updating, and database syncing.
                                </p>
                                <div className="p-4 rounded-xl bg-primary/5 border border-primary/10">
                                    <p className="text-sm text-gray-600 dark:text-gray-400 italic">
                                        QR Scanner employs Firebase secure database structure. Scan log histories and profiles are securely synced to our cloud databases under your authenticated account.
                                    </p>
                                </div>
                            </>
                        )
                        ...
                        content: (
                            <div className="space-y-4 text-gray-600 dark:text-gray-400">
                                ...
                                <p className="leading-relaxed font-bold">
                                    You are strictly responsible for maintaining the confidentiality of your account credentials, profile access, and all activities under it. Loss of your login credentials may result in loss of access to your Scan History.
                                </p>
                            </div>
                        )
                    },
                        ...
                        content: (
                            <ul className="space-y-4 text-gray-600 dark:text-gray-400">
                                ...
                                <li className="flex gap-3">
                                    ...
                                    <span>QR Scanner is not liable for data loss due to lapsed subscription backups (if applicable).</span>
                                </li>
                            </ul>
                        )
                    },
                        ...
                        content: (
                            <>
                                ...
                                <div className="grid md:grid-cols-2 gap-3">
                                    {[
                                        "Store illegal materials or barcodes obtained unlawfully",
                                        "Use the Service to distribute malware or phishing links",
                                        "Violate intellectual property rights",
                                        "Attempt to reverse engineer the scanning/generation software",
                    ...
                    },
                    {
                        ...
                        content: (
                            <div className="space-y-4 text-gray-600 dark:text-gray-400">
                                <p className="leading-relaxed">
                                    All branding, design, structure, and software remain the exclusive property of QR Scanner. Your Scan History remains exclusively yours.
                                </p>
                            </div>
                        )
                    },
                    {
                        id: "user-content",
                        title: "10. User History & Profile Data Responsibility",
                        content: (
                            <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                                <li>• You retain sole responsibility for any codes, text, or profile photos submitted to your account.</li>
                                <li>• QR Scanner cannot review or moderate your private scan history logs due to user privacy controls.</li>
                            </ul>
                        )
                    },
                    {
                        ...
                        content: (
                            <>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">To the maximum extent permitted by law, QR Scanner shall not be liable for:</p>
                                <ul className="space-y-2 text-gray-600 dark:text-gray-400 pl-4">
                                    <li>• Indirect or consequential damages</li>
                                    <li>• Loss of data due to forgotten account credentials or local device compromise</li>
                    ...
                    },
                    {
                        ...
                        content: (
                            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                                You agree to indemnify and hold harmless QR Scanner against claims arising from misuse or violation of these Terms.
                            </p>
                        )
                    },
                    {
                        ...
                        content: (
                            <div className="space-y-3 text-gray-600 dark:text-gray-400">
                                ...
                                <p>We strongly recommend keeping local backups or exporting your scan history log periodically.</p>
                            </div>
                        )
                    },
                    {
